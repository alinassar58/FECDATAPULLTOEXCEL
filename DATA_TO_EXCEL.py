# Importing the necessary libraries we need for our program.
...
# This class handles everything related to getting data from the API and saving it to an Excel file.
class ApiDataExporter:
    ...
    # This function saves the collected data into an Excel file.
    def save_to_excel(self, all_data):
        ...
        # This is the folder where we'll save the Excel file.
    ...
    def run(self):
        ...
        if all_data:
            # If we got data, save it to an Excel file.
